    ...
    f=frame :main_frame, "This is frame", size: {800, 800}, react: [:close] do
      box :vertical do
        ...
        box :horizontal do
          ...
          button :_, label: "This button\nfits exactly.", exact_fit: true
          button :_, label: "This button\nhas no border", no_border: true
        end
        box :horizontal do
          button :click_button, label: "This button\nreacts on clicks.", react: [:click]
          button :count_button, label: "This button counts\nclicks: 0", react: [:click]
          button :grow_button, label: "This button grows\nwhen you click it.", react: [:click]
        end
        box :horizontal do
          button :button, label: "This button\ndoesn't do anything."
          button :activation_button, label: "This button activate\nbutton on the left.", react: [:click]
        end
      end
    end
